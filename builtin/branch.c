...
int cmd_branch(int argc, const char **argv, const char *prefix)
{
	...
	struct option options[] = {
		...
		OPT_SET_INT(0, "gone", &filter.upstream_gone,
			    N_("print only branches that are gone upstream"),
			    REF_FILTER_UPSTREAM_GONE_INCLUDE),
		OPT_SET_INT(0, "present", &filter.upstream_gone,
			    N_("print only branches that are present upstream"),
